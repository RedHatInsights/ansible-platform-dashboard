...
const ErrorCard = () => {
  ...
  return (
    <Card className="ans-c-card-dashboard">
      <EmptyState  headingLevel="h2"   titleText={<>{intl.formatMessage(messages.errorStateTitle)}</>} variant={'full'} className="ans-c-empty-state-error" icon={ExclamationCircleIcon}>
