...
const trialMessages = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      'See how your organization can benefit from scalable automation with a Red Hat® Ansible® Automation Platform trial.',
  },
  startButton: {
...
<li>Access to Red Hat Ansible Automation Platform hosted services on Red Hat Hybrid Cloud Console</li>`,
  ...
  adCardFooter: {
    ...
    defaultMessage:
      'This product trial is not intended for production use. By proceeding, you agree to the <a>product trial terms</a>.',
  },
  reqCardHeader: {
  ...
  reqCardRHELContent: {
    ...
    defaultMessage:
      'You need to run Red Hat Enterprise Linux as your operating system for this product trial. We’ll provide next steps to download and install once your Ansible Automation Platform trial has been activated.',
  },
  reqCardBreakTitle: {
  ...
  reqCardBreakContent: {
    ...
    defaultMessage:
      'You may need to wait up to 30 minutes to access hosted services after the trial subscription is activated.',
  },
  faq1a: {
    id: 'trial.faq1a',
    defaultMessage:
  ...
  faq1b: {
    id: 'trial.faq1b',
    defaultMessage:
      'Red Hat® product trials offer all the benefits included in a Red Hat subscription. But Red Hat product trials are more than just access to the latest code. They provide access to all versions of the software, to patches and other software updates, and to our award-winning <a>Red Hat Customer Portal</a>.',
  },
  faq2a: {
    id: 'trial.faq2a',
    defaultMessage:
...
<p>Users with self-supported product trials have access to all <a>product documentation</a> as well as the vast Red Hat <a1>Knowledgebase</a1>.</p>`,
  ...
  faq6b: {
    id: 'trial.faq6b',
    defaultMessage:
      "Nearly all Red Hat technologies are available for a product trial. You can find a listing of available trials in the <a>Red Hat product trial center</a>. If there is a product you'd like to try that isn’t listed, please <a1>contact Red Hat Sales</a1>.",
  },
  faq7a: {
    id: 'trial.faq7a',
    defaultMessage:
...
<a>Contact Red Hat Sales</a> to try these technologies.`,
  ...
  faq8b: {
    id: 'trial.faq8b',
    defaultMessage:
      'There are limits to how many product trials are allowed for each product over a given time period. If you need to extend your product trial or request more trials, please <a>contact Red Hat Sales</a>.',
  },
  faq9a: {
    id: 'trial.faq9a',
    defaultMessage:
...
<p>By proceeding, you acknowledge that you've read and agree to the terms and conditions of the Red Hat Enterprise Agreement which governs your use.</p>`,
  ...
  installRHETrial: {
    ...
    defaultMessage:
      'You need to run Red Hat Enterprise Linux® as your operating system for this product trial. If you already have it, proceed to the next step. If you don’t, <button>start your download now</button>. This <a1>installation guide</a1> provides step-by-step instructions.',
  },
  startInstallTrial: {
    id: 'trial.startInstallTrial',
    defaultMessage:
      'You may need to wait up to 30 minutes to access <a1>automation hub</a1> services after the trial subscription is activated.',
  },
});
